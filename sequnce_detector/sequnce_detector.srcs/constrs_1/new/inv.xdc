...
set_property -dict {PACKAGE_PIN G21 IOSTANDARD LVCMOS18} [get_ports x]

set_property -dict {PACKAGE_PIN F15 IOSTANDARD LVCMOS18} [get_ports q1]
set_property -dict {PACKAGE_PIN F13 IOSTANDARD LVCMOS18} [get_ports q0]
